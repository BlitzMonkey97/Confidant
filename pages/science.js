...
export default function Science({scienceMentors}) {
  return (
    <>
      <Header />
      <div id="confidant_science" className="confidant_science_Class">
        {scienceMentors.map((mentor, i) =>{return(<div className="Component_57___3 Component_57__3_Class"key={i}>
        ...
        <img className="Mask_Group_36_Class" src="Mask_Group_36.png" srcSet="Mask_Group_36.png 1x, Mask_Group_36@2x.png 2x"/>
...
export async function getStaticProps() {
  ...
  const scienceMentors = await db
    .collection("ScienceCategory")
    .find()
    .project({ _id: 0, Name: 1, Topic: 1, Fees: 1 })
    .toArray();

  return {
    props: { scienceMentors },
  };
}
