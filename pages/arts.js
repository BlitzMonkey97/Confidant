...
export default function Arts({ artsMentors }) {
  return (
    <>
      <Header />
      <div id="confidant_art" className="confidant_art_Class">
        {artsMentors.map((mentor, i) =>{return(<div className="Component_57___1 Component_57__1_Class" key={i}>
...
export async function getStaticProps() {
  ...
  const artsMentors = await db
    .collection("ArtsCategory")
    .find()
